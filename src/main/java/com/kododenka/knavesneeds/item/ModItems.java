...
public class ModItems {
    ...
    //Blue Skies
    static int TURQUOISE_STONE_MOD = 0;
    static int LUNAR_STONE_MOD = 0;
    static int PYROPE_MOD = 0;
    static int AQUITE_MOD = 0;
    static int DIOPSIDE_MOD = 0;
    static int CHARROITE_MOD = 0;
    static int HORIZONITE_MOD = 0;

    //Blue Skies Woods
    static int BLUEBRIGHT_WOOD_MOD = 0;
    static int LUNAR_WOOD_MOD = 0;
    static int STARLIT_WOOD_MOD = 0;
    static int DUSK_WOOD_MOD = 0;
    static int FROSTBRIGHT_WOOD_MOD = 0;
    static int MAPLE_WOOD_MOD = 0;
    static int CHERRY_WOOD_MOD = 0;
    ...
    public static final DeferredRegister<Item> BLUE_ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, "blue_skies");
    ...
    public static final RegistryObject<Item> turquoise_stone_longsword = BLUE_ITEMS.register("turquoise_stone_longsword", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_twinblade = BLUE_ITEMS.register("turquoise_stone_twinblade", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_rapier = BLUE_ITEMS.register("turquoise_stone_rapier", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_katana = BLUE_ITEMS.register("turquoise_stone_katana", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_sai = BLUE_ITEMS.register("turquoise_stone_sai", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_spear = BLUE_ITEMS.register("turquoise_stone_spear", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_glaive = BLUE_ITEMS.register("turquoise_stone_glaive", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_warglaive = BLUE_ITEMS.register("turquoise_stone_warglaive", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_cutlass = BLUE_ITEMS.register("turquoise_stone_cutlass", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_claymore = BLUE_ITEMS.register("turquoise_stone_claymore", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_greataxe = BLUE_ITEMS.register("turquoise_stone_greataxe", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_greathammer = BLUE_ITEMS.register("turquoise_stone_greathammer", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_chakram = BLUE_ITEMS.register("turquoise_stone_chakram", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> turquoise_stone_scythe = BLUE_ITEMS.register("turquoise_stone_scythe", () -> new KNSwordItem(TURQUOISE_STONE, TURQUOISE_STONE_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - LUNAR_STONE
    public static final RegistryObject<Item> lunar_stone_longsword = BLUE_ITEMS.register("lunar_stone_longsword", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> lunar_stone_twinblade = BLUE_ITEMS.register("lunar_stone_twinblade", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> lunar_stone_rapier = BLUE_ITEMS.register("lunar_stone_rapier", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> lunar_stone_katana = BLUE_ITEMS.register("lunar_stone_katana", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> lunar_stone_sai = BLUE_ITEMS.register("lunar_stone_sai", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> lunar_stone_spear = BLUE_ITEMS.register("lunar_stone_spear", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> lunar_stone_glaive = BLUE_ITEMS.register("lunar_stone_glaive", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> lunar_stone_warglaive = BLUE_ITEMS.register("lunar_stone_warglaive", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> lunar_stone_cutlass = BLUE_ITEMS.register("lunar_stone_cutlass", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> lunar_stone_claymore = BLUE_ITEMS.register("lunar_stone_claymore", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> lunar_stone_greataxe = BLUE_ITEMS.register("lunar_stone_greataxe", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> lunar_stone_greathammer = BLUE_ITEMS.register("lunar_stone_greathammer", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> lunar_stone_chakram = BLUE_ITEMS.register("lunar_stone_chakram", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> lunar_stone_scythe = BLUE_ITEMS.register("lunar_stone_scythe", () -> new KNSwordItem(LUNAR_STONE, LUNAR_STONE_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - PYROPE
    public static final RegistryObject<Item> pyrope_longsword = BLUE_ITEMS.register("pyrope_longsword", () -> new KNSwordItem(PYROPE, PYROPE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> pyrope_twinblade = BLUE_ITEMS.register("pyrope_twinblade", () -> new KNSwordItem(PYROPE, PYROPE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> pyrope_rapier = BLUE_ITEMS.register("pyrope_rapier", () -> new KNSwordItem(PYROPE, PYROPE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> pyrope_katana = BLUE_ITEMS.register("pyrope_katana", () -> new KNSwordItem(PYROPE, PYROPE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> pyrope_sai = BLUE_ITEMS.register("pyrope_sai", () -> new KNSwordItem(PYROPE, PYROPE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> pyrope_spear = BLUE_ITEMS.register("pyrope_spear", () -> new KNSwordItem(PYROPE, PYROPE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> pyrope_glaive = BLUE_ITEMS.register("pyrope_glaive", () -> new KNSwordItem(PYROPE, PYROPE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> pyrope_warglaive = BLUE_ITEMS.register("pyrope_warglaive", () -> new KNSwordItem(PYROPE, PYROPE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> pyrope_cutlass = BLUE_ITEMS.register("pyrope_cutlass", () -> new KNSwordItem(PYROPE, PYROPE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> pyrope_claymore = BLUE_ITEMS.register("pyrope_claymore", () -> new KNSwordItem(PYROPE, PYROPE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> pyrope_greataxe = BLUE_ITEMS.register("pyrope_greataxe", () -> new KNSwordItem(PYROPE, PYROPE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> pyrope_greathammer = BLUE_ITEMS.register("pyrope_greathammer", () -> new KNSwordItem(PYROPE, PYROPE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> pyrope_chakram = BLUE_ITEMS.register("pyrope_chakram", () -> new KNSwordItem(PYROPE, PYROPE_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> pyrope_scythe = BLUE_ITEMS.register("pyrope_scythe", () -> new KNSwordItem(PYROPE, PYROPE_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - AQUITE
    public static final RegistryObject<Item> aquite_longsword = BLUE_ITEMS.register("aquite_longsword", () -> new KNSwordItem(AQUITE, AQUITE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> aquite_twinblade = BLUE_ITEMS.register("aquite_twinblade", () -> new KNSwordItem(AQUITE, AQUITE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> aquite_rapier = BLUE_ITEMS.register("aquite_rapier", () -> new KNSwordItem(AQUITE, AQUITE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> aquite_katana = BLUE_ITEMS.register("aquite_katana", () -> new KNSwordItem(AQUITE, AQUITE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> aquite_sai = BLUE_ITEMS.register("aquite_sai", () -> new KNSwordItem(AQUITE, AQUITE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> aquite_spear = BLUE_ITEMS.register("aquite_spear", () -> new KNSwordItem(AQUITE, AQUITE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> aquite_glaive = BLUE_ITEMS.register("aquite_glaive", () -> new KNSwordItem(AQUITE, AQUITE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> aquite_warglaive = BLUE_ITEMS.register("aquite_warglaive", () -> new KNSwordItem(AQUITE, AQUITE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> aquite_cutlass = BLUE_ITEMS.register("aquite_cutlass", () -> new KNSwordItem(AQUITE, AQUITE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> aquite_claymore = BLUE_ITEMS.register("aquite_claymore", () -> new KNSwordItem(AQUITE, AQUITE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> aquite_greataxe = BLUE_ITEMS.register("aquite_greataxe", () -> new KNSwordItem(AQUITE, AQUITE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> aquite_greathammer = BLUE_ITEMS.register("aquite_greathammer", () -> new KNSwordItem(AQUITE, AQUITE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> aquite_chakram = BLUE_ITEMS.register("aquite_chakram", () -> new KNSwordItem(AQUITE, AQUITE_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> aquite_scythe = BLUE_ITEMS.register("aquite_scythe", () -> new KNSwordItem(AQUITE, AQUITE_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - DIOPSIDE
    public static final RegistryObject<Item> diopside_longsword = BLUE_ITEMS.register("diopside_longsword", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> diopside_twinblade = BLUE_ITEMS.register("diopside_twinblade", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> diopside_rapier = BLUE_ITEMS.register("diopside_rapier", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> diopside_katana = BLUE_ITEMS.register("diopside_katana", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> diopside_sai = BLUE_ITEMS.register("diopside_sai", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> diopside_spear = BLUE_ITEMS.register("diopside_spear", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> diopside_glaive = BLUE_ITEMS.register("diopside_glaive", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> diopside_warglaive = BLUE_ITEMS.register("diopside_warglaive", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> diopside_cutlass = BLUE_ITEMS.register("diopside_cutlass", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> diopside_claymore = BLUE_ITEMS.register("diopside_claymore", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> diopside_greataxe = BLUE_ITEMS.register("diopside_greataxe", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> diopside_greathammer = BLUE_ITEMS.register("diopside_greathammer", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> diopside_chakram = BLUE_ITEMS.register("diopside_chakram", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> diopside_scythe = BLUE_ITEMS.register("diopside_scythe", () -> new KNSwordItem(DIOPSIDE, DIOPSIDE_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - CHARROITE
    public static final RegistryObject<Item> charroite_longsword = BLUE_ITEMS.register("charroite_longsword", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> charroite_twinblade = BLUE_ITEMS.register("charroite_twinblade", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> charroite_rapier = BLUE_ITEMS.register("charroite_rapier", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> charroite_katana = BLUE_ITEMS.register("charroite_katana", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> charroite_sai = BLUE_ITEMS.register("charroite_sai", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> charroite_spear = BLUE_ITEMS.register("charroite_spear", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> charroite_glaive = BLUE_ITEMS.register("charroite_glaive", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> charroite_warglaive = BLUE_ITEMS.register("charroite_warglaive", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> charroite_cutlass = BLUE_ITEMS.register("charroite_cutlass", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> charroite_claymore = BLUE_ITEMS.register("charroite_claymore", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> charroite_greataxe = BLUE_ITEMS.register("charroite_greataxe", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> charroite_greathammer = BLUE_ITEMS.register("charroite_greathammer", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> charroite_chakram = BLUE_ITEMS.register("charroite_chakram", () -> new KNSwordItem(CHARROITE, CHARROITE_MOD + chakram_damage_mod, chakram_speed_mod));
    ...
    public static final RegistryObject<Item> bluebright_wood_twinblade = BLUE_ITEMS.register("bluebright_wood_twinblade", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_rapier = BLUE_ITEMS.register("bluebright_wood_rapier", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_katana = BLUE_ITEMS.register("bluebright_wood_katana", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_sai = BLUE_ITEMS.register("bluebright_wood_sai", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_spear = BLUE_ITEMS.register("bluebright_wood_spear", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_glaive = BLUE_ITEMS.register("bluebright_wood_glaive", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_warglaive = BLUE_ITEMS.register("bluebright_wood_warglaive", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_cutlass = BLUE_ITEMS.register("bluebright_wood_cutlass", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_claymore = BLUE_ITEMS.register("bluebright_wood_claymore", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_greataxe = BLUE_ITEMS.register("bluebright_wood_greataxe", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_greathammer = BLUE_ITEMS.register("bluebright_wood_greathammer", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_chakram = BLUE_ITEMS.register("bluebright_wood_chakram", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> bluebright_wood_scythe = BLUE_ITEMS.register("bluebright_wood_scythe", () -> new KNSwordItem(BLUEBRIGHT_WOOD, BLUEBRIGHT_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - LUNAR_WOOD
    public static final RegistryObject<Item> lunar_wood_longsword = BLUE_ITEMS.register("lunar_wood_longsword", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> lunar_wood_twinblade = BLUE_ITEMS.register("lunar_wood_twinblade", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> lunar_wood_rapier = BLUE_ITEMS.register("lunar_wood_rapier", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> lunar_wood_katana = BLUE_ITEMS.register("lunar_wood_katana", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> lunar_wood_sai = BLUE_ITEMS.register("lunar_wood_sai", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> lunar_wood_spear = BLUE_ITEMS.register("lunar_wood_spear", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> lunar_wood_glaive = BLUE_ITEMS.register("lunar_wood_glaive", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> lunar_wood_warglaive = BLUE_ITEMS.register("lunar_wood_warglaive", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> lunar_wood_cutlass = BLUE_ITEMS.register("lunar_wood_cutlass", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> lunar_wood_claymore = BLUE_ITEMS.register("lunar_wood_claymore", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> lunar_wood_greataxe = BLUE_ITEMS.register("lunar_wood_greataxe", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> lunar_wood_greathammer = BLUE_ITEMS.register("lunar_wood_greathammer", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> lunar_wood_chakram = BLUE_ITEMS.register("lunar_wood_chakram", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> lunar_wood_scythe = BLUE_ITEMS.register("lunar_wood_scythe", () -> new KNSwordItem(LUNAR_WOOD, LUNAR_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - STARLIT_WOOD
    public static final RegistryObject<Item> starlit_wood_longsword = BLUE_ITEMS.register("starlit_wood_longsword", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> starlit_wood_twinblade = BLUE_ITEMS.register("starlit_wood_twinblade", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> starlit_wood_rapier = BLUE_ITEMS.register("starlit_wood_rapier", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> starlit_wood_katana = BLUE_ITEMS.register("starlit_wood_katana", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> starlit_wood_sai = BLUE_ITEMS.register("starlit_wood_sai", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> starlit_wood_spear = BLUE_ITEMS.register("starlit_wood_spear", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> starlit_wood_glaive = BLUE_ITEMS.register("starlit_wood_glaive", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> starlit_wood_warglaive = BLUE_ITEMS.register("starlit_wood_warglaive", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> starlit_wood_cutlass = BLUE_ITEMS.register("starlit_wood_cutlass", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> starlit_wood_claymore = BLUE_ITEMS.register("starlit_wood_claymore", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> starlit_wood_greataxe = BLUE_ITEMS.register("starlit_wood_greataxe", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> starlit_wood_greathammer = BLUE_ITEMS.register("starlit_wood_greathammer", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> starlit_wood_chakram = BLUE_ITEMS.register("starlit_wood_chakram", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> starlit_wood_scythe = BLUE_ITEMS.register("starlit_wood_scythe", () -> new KNSwordItem(STARLIT_WOOD, STARLIT_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - DUSK_WOOD
    public static final RegistryObject<Item> dusk_wood_longsword = BLUE_ITEMS.register("dusk_wood_longsword", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> dusk_wood_twinblade = BLUE_ITEMS.register("dusk_wood_twinblade", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> dusk_wood_rapier = BLUE_ITEMS.register("dusk_wood_rapier", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> dusk_wood_katana = BLUE_ITEMS.register("dusk_wood_katana", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> dusk_wood_sai = BLUE_ITEMS.register("dusk_wood_sai", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> dusk_wood_spear = BLUE_ITEMS.register("dusk_wood_spear", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> dusk_wood_glaive = BLUE_ITEMS.register("dusk_wood_glaive", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> dusk_wood_warglaive = BLUE_ITEMS.register("dusk_wood_warglaive", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> dusk_wood_cutlass = BLUE_ITEMS.register("dusk_wood_cutlass", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> dusk_wood_claymore = BLUE_ITEMS.register("dusk_wood_claymore", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> dusk_wood_greataxe = BLUE_ITEMS.register("dusk_wood_greataxe", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> dusk_wood_greathammer = BLUE_ITEMS.register("dusk_wood_greathammer", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> dusk_wood_chakram = BLUE_ITEMS.register("dusk_wood_chakram", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> dusk_wood_scythe = BLUE_ITEMS.register("dusk_wood_scythe", () -> new KNSwordItem(DUSK_WOOD, DUSK_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - FROSTBRIGHT_WOOD
    public static final RegistryObject<Item> frostbright_wood_longsword = BLUE_ITEMS.register("frostbright_wood_longsword", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_twinblade = BLUE_ITEMS.register("frostbright_wood_twinblade", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_rapier = BLUE_ITEMS.register("frostbright_wood_rapier", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_katana = BLUE_ITEMS.register("frostbright_wood_katana", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_sai = BLUE_ITEMS.register("frostbright_wood_sai", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_spear = BLUE_ITEMS.register("frostbright_wood_spear", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_glaive = BLUE_ITEMS.register("frostbright_wood_glaive", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_warglaive = BLUE_ITEMS.register("frostbright_wood_warglaive", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_cutlass = BLUE_ITEMS.register("frostbright_wood_cutlass", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_claymore = BLUE_ITEMS.register("frostbright_wood_claymore", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_greataxe = BLUE_ITEMS.register("frostbright_wood_greataxe", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_greathammer = BLUE_ITEMS.register("frostbright_wood_greathammer", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_chakram = BLUE_ITEMS.register("frostbright_wood_chakram", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> frostbright_wood_scythe = BLUE_ITEMS.register("frostbright_wood_scythe", () -> new KNSwordItem(FROSTBRIGHT_WOOD, FROSTBRIGHT_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - MAPLE_WOOD
    public static final RegistryObject<Item> maple_wood_longsword = BLUE_ITEMS.register("maple_wood_longsword", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> maple_wood_twinblade = BLUE_ITEMS.register("maple_wood_twinblade", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> maple_wood_rapier = BLUE_ITEMS.register("maple_wood_rapier", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> maple_wood_katana = BLUE_ITEMS.register("maple_wood_katana", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> maple_wood_sai = BLUE_ITEMS.register("maple_wood_sai", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> maple_wood_spear = BLUE_ITEMS.register("maple_wood_spear", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> maple_wood_glaive = BLUE_ITEMS.register("maple_wood_glaive", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> maple_wood_warglaive = BLUE_ITEMS.register("maple_wood_warglaive", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> maple_wood_cutlass = BLUE_ITEMS.register("maple_wood_cutlass", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> maple_wood_claymore = BLUE_ITEMS.register("maple_wood_claymore", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> maple_wood_greataxe = BLUE_ITEMS.register("maple_wood_greataxe", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> maple_wood_greathammer = BLUE_ITEMS.register("maple_wood_greathammer", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> maple_wood_chakram = BLUE_ITEMS.register("maple_wood_chakram", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> maple_wood_scythe = BLUE_ITEMS.register("maple_wood_scythe", () -> new KNSwordItem(MAPLE_WOOD, MAPLE_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Material - CHERRY_WOOD
    public static final RegistryObject<Item> cherry_wood_longsword = BLUE_ITEMS.register("cherry_wood_longsword", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + longsword_damage_mod, longsword_speed_mod));
    public static final RegistryObject<Item> cherry_wood_twinblade = BLUE_ITEMS.register("cherry_wood_twinblade", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + twinblade_damage_mod, twinblade_speed_mod));
    public static final RegistryObject<Item> cherry_wood_rapier = BLUE_ITEMS.register("cherry_wood_rapier", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + rapier_damage_mod, rapier_speed_mod));
    public static final RegistryObject<Item> cherry_wood_katana = BLUE_ITEMS.register("cherry_wood_katana", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + katana_damage_mod, katana_speed_mod));
    public static final RegistryObject<Item> cherry_wood_sai = BLUE_ITEMS.register("cherry_wood_sai", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + sai_damage_mod, sai_speed_mod));
    public static final RegistryObject<Item> cherry_wood_spear = BLUE_ITEMS.register("cherry_wood_spear", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + spear_damage_mod, spear_speed_mod));
    public static final RegistryObject<Item> cherry_wood_glaive = BLUE_ITEMS.register("cherry_wood_glaive", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + glaive_damage_mod, glaive_speed_mod));
    public static final RegistryObject<Item> cherry_wood_warglaive = BLUE_ITEMS.register("cherry_wood_warglaive", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + warglaive_damage_mod, warglaive_speed_mod));
    public static final RegistryObject<Item> cherry_wood_cutlass = BLUE_ITEMS.register("cherry_wood_cutlass", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + cutlass_damage_mod, cutlass_speed_mod));
    public static final RegistryObject<Item> cherry_wood_claymore = BLUE_ITEMS.register("cherry_wood_claymore", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + claymore_damage_mod, claymore_speed_mod));
    public static final RegistryObject<Item> cherry_wood_greataxe = BLUE_ITEMS.register("cherry_wood_greataxe", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + greataxe_damage_mod, greataxe_speed_mod));
    public static final RegistryObject<Item> cherry_wood_greathammer = BLUE_ITEMS.register("cherry_wood_greathammer", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + greathammer_damage_mod, greathammer_speed_mod));
    public static final RegistryObject<Item> cherry_wood_chakram = BLUE_ITEMS.register("cherry_wood_chakram", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + chakram_damage_mod, chakram_speed_mod));
    public static final RegistryObject<Item> cherry_wood_scythe = BLUE_ITEMS.register("cherry_wood_scythe", () -> new KNSwordItem(CHERRY_WOOD, CHERRY_WOOD_MOD + scythe_damage_mod, scythe_speed_mod));

    //Reg items to item bus
    public static void register(IEventBus eventBus) {
        ITEMS.register(eventBus);
        BLUE_ITEMS.register(eventBus);
    }
